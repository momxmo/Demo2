...
import com.easemob.easeui.DemoApplication;
...
public class MainActivity extends EaseBaseActivity {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case DemoApplication.MY_PERMISSIONS_REQUEST_RECORD_AUDIO: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    DemoApplication.permission_record_audio = true;
                } else {
                    DemoApplication.permission_record_audio = false;
                }
            }
            case DemoApplication.MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGES: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    DemoApplication.write_external_storage = true;
                } else {
                    DemoApplication.write_external_storage = false;
                }
            }
    ...
    private void initPermission() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(this,
                    ...
                    DemoApplication.MY_PERMISSIONS_REQUEST_RECORD_AUDIO);
        }
        if (ContextCompat.checkSelfPermission(this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                    DemoApplication.MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGES);
        }
    }
}
